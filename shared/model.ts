...
export type GraphLink = { organizerId: string; onlineMeetingId: string; subscriptionId?: string; clientState?: string; expiresAt?: string };
...
export type Meeting = {
  ...
  createdBy: string; members: string[]; createdAt: string; updatedAt: string;
...
export type Tension = { id: string; version: number; title: string; description: string; circle: string; createdBy: string; createdAt: string; updatedAt: string; status: 'open' | 'resolved'; members: string[] };
export type Bootstrap = { tensions: Tension[]; actor: Actor; templates: Template[]; meetings: Meeting[]; integrations: { governance?: boolean; autoAnalysis: boolean; entityTypes: OutputType[]; storage: string; ai: boolean; mcp: boolean; graph: boolean; authMode: string } };
